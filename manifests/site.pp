...
node default {
    ...
    case $hostname {
        ...
        bartok,schein,steffani,ries,franck:   { include named::recursor }
    }
    ...
    case $hostname {
        busoni,englund,orff,duarte,grieg,soler,krenek,lindberg,morricone,respighi,scelsi,valente,vitry,vivaldi,wolkenstein,rietz,unger: { include ferm }
    }
